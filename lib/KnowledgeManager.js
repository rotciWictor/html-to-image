...
class KnowledgeManager {
  ...
  loadMasterPrompt() {
    ...
    // Fallback: prompt enxuto padrão que permite a geração seguir sem interromper o fluxo
    console.warn('⚠️ Prompt mestre não encontrado. Usando prompt padrão mínimo.');
    return `Você é um gerador de HTMLs responsivos. Gere HTMLs válidos com <!DOCTYPE html>, <html>, <head>, <body> e inclua um <script id="h2i-config" type="application/json"> com configuração de conversão.`;
  }
