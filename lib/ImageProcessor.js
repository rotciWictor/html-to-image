...
class ImageProcessor {
  ...
  async processArchive(archivePath, outputDir = null) {
    ...
    try {
      ...
      const { htmlFiles, extractPath: tempPath } = await this.archiveProcessor.processArchive(archivePath);
      ...
      const results = await this.processMultipleFiles(htmlFiles, { outputDir });
      ...
      if (extractPath) {
        this.archiveProcessor.cleanup(extractPath);
      }
    }
  }
