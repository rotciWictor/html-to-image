      ...
      try {
        ...
        if (isOverloaded && attempt < maxRetries) {
          ...
          if (retryMatch && retryMatch[1]) {
            delaySecs = Math.ceil(parseFloat(retryMatch[1])) + 1;
          }

          console.log(`\n⚠️  Gerador de Imagem atingiu o limite. Aguardando ${delaySecs} segundos para tentar novamente... (Tentativa ${attempt}/${maxRetries})`);
